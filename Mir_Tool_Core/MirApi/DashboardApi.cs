...
{
    public async Task<List<DashboardApiSchema.GetDashboardSnapshot>?> GetDashboards(ApiCaller caller)
    {
    ...
    public async Task<DashboardApiSchema.GetDashboardByGuidSnapshot> GetDashboardByGuid(ApiCaller caller, String guid)
    {
    ...
    public async Task<String> PostDashboard(ApiCaller caller, String guid, String name, String fleetDashboard)
    {
    ...
    public async Task<String> PutDashboard(ApiCaller caller, String guid, String name, String fleetDashboard)
    {
        dynamic dashboard = new
        {
            name,
    ...
    public void DeleteDashboard(ApiCaller caller, String guid)
    {
        caller.DeleteApi($"dashboards/{guid}");
    }
    public async Task<List<DashboardApiSchema.GetWidgetsByDashboardSnapshot>?> GetWidgetsByDashboard(ApiCaller caller, String dashboardGuid)
    {
    ...
    public async Task<DashboardApiSchema.GetWidgetByGuidSnapshot> GetWidgetByGuid(ApiCaller caller, String dashboardGuid, String widgetGuid)
    {
    ...
    public async Task<String> PostWidget(ApiCaller caller, String guid, String dashboardId, String settings)
    {
        dynamic widget = new
        {
            guid,
    ...
    public async Task<String> PutWidget(ApiCaller caller, String guid, String dashboardId, String settings)
    {
        dynamic widget = new
        {
            settings
    ...
    public void DeleteWidget(ApiCaller caller, String dashboardId, String guid)
    {
